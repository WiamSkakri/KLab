# This increases the number of hidden layers in the neural network
...
class CNNExecutionPredictor(nn.Module):
    def __init__(self, input_size, dropout_rate=0.3):
        ...
        # Enhanced deeper architecture for better feature learning
        # Layer dimensions: gradually reducing from input to output

        # First layer - wide to capture complex input patterns
        ...
        # Fourth layer
        self.layer4 = nn.Linear(128, 96)
        self.batch_norm4 = nn.BatchNorm1d(96)

        # Fifth layer
        self.layer5 = nn.Linear(96, 64)
    ...
    def _initialize_weights(self):
        """Initialize weights using He initialization for better deep network training"""
...
# Training parameters
epochs = 200  # Increased from 150 for deeper network convergence
patience = 30  # Increased patience for deeper networks
input_size = X.shape[1]
learning_rate = 0.0005  # Reduced learning rate for deeper networks
...
for fold_data in fold_results:
    ...
    for epoch in range(epochs):
        ...
        for X_batch, y_batch in train_loader:
            ...
            # Gradient clipping for stability (more conservative for deeper networks)
