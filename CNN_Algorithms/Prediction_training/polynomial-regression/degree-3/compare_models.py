...
print_with_timestamp(
    "Starting Polynomial Regression (Degree 3) Model Comparison")

# Check which result files exist
result_files = {
    'Linear': 'linear_degree3_training_results.csv',
    'Ridge': 'ridge_degree3_training_results.csv',
    'Lasso': 'lasso_degree3_training_results.csv',
    'ElasticNet': 'elasticnet_degree3_training_results.csv'
}
...
print_with_timestamp("\n📊 MODEL COMPARISON SUMMARY (DEGREE 3)")
...
fig.suptitle('Polynomial Regression (Degree 3) Model Comparison',
...
# Create summary text
summary_text = "Degree 3 Polynomial Model Comparison\n"
summary_text += "=" * 35 + "\n\n"
...
plt.tight_layout()
plt.savefig('polynomial_degree3_models_comparison.png',
            dpi=300, bbox_inches='tight')
plt.close()

# Save comparison results
summary_df.to_csv('polynomial_degree3_models_comparison.csv', index=False)

print_with_timestamp(
    "✅ Comparison visualization saved: polynomial_degree3_models_comparison.png")
print_with_timestamp(
    "✅ Comparison results saved: polynomial_degree3_models_comparison.csv")
...
print_with_timestamp(f"\n💡 Model Characteristics (Degree 3):")
...
print_with_timestamp(
    f"\n🎉 Polynomial Regression (Degree 3) Model Comparison Complete!")
print_with_timestamp(f"📁 Generated files:")
print_with_timestamp(
    f"   • polynomial_degree3_models_comparison.png - Visual comparison")
print_with_timestamp(
    f"   • polynomial_degree3_models_comparison.csv - Detailed metrics")
