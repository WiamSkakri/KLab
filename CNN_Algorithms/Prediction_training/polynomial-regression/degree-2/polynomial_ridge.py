...
print_with_timestamp(
    "Starting RIDGE Polynomial Regression CNN Execution Time Prediction Training")
...
print_with_timestamp(
    f"Training RIDGE Polynomial Regression with {k}-Fold Cross Validation")
...
# Hyperparameter grid for RIDGE regression (degree 2 only)
param_grid = {
...
print_with_timestamp(f"🔢 TRAINING RIDGE POLYNOMIAL REGRESSION")
...
for fold, (train_idx, val_idx) in enumerate(kf.split(X), 1):
    ...
    # Print fold results
    print_with_timestamp(f"🔢 RIDGE Fold {fold} Results:")
...
print_with_timestamp(f"\n{'='*80}")
print_with_timestamp("🔢 RIDGE POLYNOMIAL REGRESSION SUMMARY")
...
fig.suptitle('Ridge Polynomial Regression Results',
...
print_with_timestamp("✅ Visualization saved: ridge_polynomial_results.png")

print_with_timestamp(f"\n🎉 Ridge Polynomial Regression Training Complete!")
print_with_timestamp(
...
print_with_timestamp(f"  • ridge_polynomial_results.png - Visualization")
