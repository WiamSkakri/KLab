...
def main():
    """Main function to run DenseNet121 AI3 Implicit GEMM performance testing"""
    print("="*80)
    print("DENSENET121 AI3 IMPLICIT GEMM IMPLEMENTATION")
    print("="*80)
    ...
    try:
        if device == "cuda":
            if ai3_conversion_successful:
                ...
                # AI3 conversion failed, manually move model to device
                print("AI3 conversion failed, manually moving model to CUDA...")
    ...
    print("This will test the model with various input sizes to measure AI3 Implicit GEMM performance.")
    ...
    print(f"\n{'='*80}")
    print("DENSENET121 AI3 IMPLICIT GEMM TESTING COMPLETED")
    print(f"{'='*80}")
    ...
    print(f"  ✓ AI3 Implicit GEMM algorithm optimization")
    print(f"  ✓ Comprehensive layer-wise performance analysis")
    print()
    print("Next steps:")
    print("  1. Analyze the CSV files to compare AI3 Implicit GEMM performance vs other algorithms")
    print("  2. Run the same test with different AI3 algorithms (gemm, winograd, etc.) for comparison")
    print("  3. Compare AI3 implementation vs custom implementations")
    print(f"{'='*80}")
