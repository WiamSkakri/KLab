#!/bin/bash
#SBATCH -J densenet_implicit_gemm_gpuL40s    # Job name
#SBATCH -o densenet_implicit_gemm_gpuL40s.out  # Output file
...
SCRATCH_DIR=$PFSDIR/densenet_implicit_gemm_gpuL40s_${SLURM_JOB_ID}
