...
def main():
    """Main function to run DenseNet121 GEMM performance testing"""
    print("="*80)
    print("DENSENET121 GEMM IMPLEMENTATION WITH AI3 LIBRARY")
    print("="*80)
    ...
    print(f"\n{'='*80}")
    print("DENSENET121 GEMM TESTING COMPLETED")
    print(f"{'='*80}")
