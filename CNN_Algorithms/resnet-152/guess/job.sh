#!/bin/bash
#SBATCH -J resnet152_guess_gpu    # Job name
#SBATCH -o resnet152_guess_gpu.out  # Output file
...
SCRATCH_DIR=$PFSDIR/resnet152_guess_gpu_${SLURM_JOB_ID}
...
echo "Running ResNet-152 Guess Algorithm Python script..."
...
echo "==============="
if [ -f "ResNet152_guess_cuda_overall.csv" ]; then
    echo "Overall results file: ResNet152_guess_cuda_overall.csv"
    echo "Number of test cases: $(tail -n +2 ResNet152_guess_cuda_overall.csv | wc -l)"
fi

if [ -f "ResNet152_guess_cuda_layers.csv" ]; then
    echo "Layer-wise results file: ResNet152_guess_cuda_layers.csv"
    echo "Number of layer measurements: $(tail -n +2 ResNet152_guess_cuda_layers.csv | wc -l)"
fi
...
echo "==========================================="
echo "ResNet-152 Guess Algorithm Job completed successfully!"
