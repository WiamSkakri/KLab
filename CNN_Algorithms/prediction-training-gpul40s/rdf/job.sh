...
echo "============================================="
echo "GPU Random Forest Training Job Started"
echo "============================================="
...
if [ -f "combined_l40s.csv" ]; then
    echo "✅ Data file found: combined_l40s.csv"
...
echo -e "\n========================================="
echo "Starting GPU Random Forest Training"
echo "========================================="
...
# Run the GPU training script with comprehensive logging
echo -e "\n🚀 Executing GPU Random Forest training..."
python python.py 2>&1 | tee training_output.log

TRAINING_EXIT_CODE=$?

echo -e "\n========================================="
echo "GPU Training Completion"
echo "========================================="
echo "End time: $(date)"
...
" 2>/dev/null || echo "Could not display performance summary"
    ...
    echo "❌ GPU training failed with exit code: $TRAINING_EXIT_CODE"
