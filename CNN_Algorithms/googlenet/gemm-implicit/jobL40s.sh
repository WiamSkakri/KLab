#!/bin/bash
#SBATCH -J googlenet_implicit_gemm_gpuL40s      # Job name
#SBATCH -o googlenet_implicit_gemm_gpuL40s.out  # Output file
...
SCRATCH_DIR=$PFSDIR/googlenet_implicit_gemm_gpuL40s_${SLURM_JOB_ID}
