#!/bin/bash
#SBATCH -J googlenet_implicit_gemm_gpu2v100      # Job name
#SBATCH -o googlenet_implicit_gemm_gpu2v100.out  # Output file
...
SCRATCH_DIR=$PFSDIR/googlenet_implicit_gemm_gpu_${SLURM_JOB_ID}
